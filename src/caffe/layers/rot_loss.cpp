...
const vector<bool>& propagate_down, const vector<Blob<Dtype>*>& bottom) {
        ...
        if(propagate_down[0]) {
            ...
            for(int i=0; i< num; i++)
            {
                ...
                float fdx11 =  - 2.0f*y11 + 2.0f*x11*y11*y11 + 2.0f*y11*x12*y21
                               + 2.0f*y11*x13*y31 + 2.0f*x11*y12*y12 + 2.0f*y12*x12*y22
                               + 2.0f*y12*x13*y32 + 2.0f*x11*y13*y13 + 2.0f*y13*x12*y23
                               + 2.0f*y13*x13*y33;

                float fdx12 =  - 2.0f*y21 + 2.0f*x12*y21*y21 + 2.0f*x11*y11*y21 + 2.0f*y21*x13*y31
                               + 2.0f*x12*y22*y22 + 2.0f*x11*y12 + y22 + 2.0f*y22*x13*y32 + 2.0f*x12*y23*y23
                               + 2.0f*x11*y13*y23 + 2.0f*y23*x13*y33;
                float fdx13 =  - 2.0f*y31*y31 + 2.0f*x13*y31*y31 + 2.0f*x11*y11*y31 + 2.0f*x12*y21*y31
                               + 2.0f*x13*y32*y32 + 2.0f*x11*y12*y32 + 2.0f*x12*y22*y32 + 2.0f*x13*y33*y33
                               + 2.0f*x11*y13*y33 + 2.0*x12*y23*y33;

                float fdx21 = 2.0f*x21*y11*y11 + 2.0f*y11*x22*y21 + 2.0f*y11*x23*y31 - 2.0f*y12*y12
                              + 2.0f*x21*y12*y12 + 2.0f*y12*x22*y22 + 2.0f*y12*x23*y32 + 2.0f*x21*y13*y13
                              + 2.0f*y13*x22*y23 + 2.0f*y13*x23*y33;

                float fdx22 = 2.0f*x22*y21*y21 + 2.0f*x21*y11*y21 + 2.0f*y21*x23*y31 - 2.0f*y22*y22
                ...
                float fdx31 = 2.0f*x31*y11*y11 + 2.0f*y11*x32*y21 + 2.0f*y11*x33*y31 + 2.0f*x31*y12*y12 + 2.0f*y12*x32*y22
                              + 2.0f*y12*x33*y32 - 2.0f*y13 + 2.0f*x31*y13*y13 + 2.0f*y13*x32*y23 + 2.0f*y13*x33*y33;

                float fdx32 = 2.0f*x32*y21*y21 + 2.0f*x31*y11*y21 + 2.0f*y21*x33*y31 + 2.0f*x32*y22*y22 + 2.0*x31*y12*y22
                              + 2.0f*y22*x33*y32 - 2.0f*y23 + 2.0f*x32*y23*y23 + 2.0f*x31*y13*y23 + 2.0*y23*x33*y33;

                float fdx33 = 2.0f*x33*y31*y31 + 2.0f*x31*y11*y31 + 2.0f*x32*y21*y31 + 2.0f*x33*y32*y32 + 2.0f*x31*y12*y32
                              + 2.0f*x32*y22*y32 - 2.0f*y33 + 2.0f*x33*y33*y33 + 2.0f*x31*y13*y33 + 2.0f*x32*y23*y33;



                bottom[0]->mutable_cpu_diff()[9*i +0]= top[0]->cpu_diff()[9*i+0] * fdx11;
                bottom[0]->mutable_cpu_diff()[9*i +3]= top[0]->cpu_diff()[9*i+3] * fdx12;
                bottom[0]->mutable_cpu_diff()[9*i +6]= top[0]->cpu_diff()[9*i+6] * fdx13;
                bottom[0]->mutable_cpu_diff()[9*i +1]= top[0]->cpu_diff()[9*i+1] * fdx21;
                bottom[0]->mutable_cpu_diff()[9*i +4]= top[0]->cpu_diff()[9*i+4] * fdx22;
                bottom[0]->mutable_cpu_diff()[9*i +7]= top[0]->cpu_diff()[9*i+7] * fdx23;
                bottom[0]->mutable_cpu_diff()[9*i +2]= top[0]->cpu_diff()[9*i+2] * fdx31;
                bottom[0]->mutable_cpu_diff()[9*i +5]= top[0]->cpu_diff()[9*i+5] * fdx32;
                bottom[0]->mutable_cpu_diff()[9*i +8]= top[0]->cpu_diff()[9*i+8] * fdx33;
