...
class ProjectiveTransformerLayer : public Layer<Dtype> {

public:
	explicit ProjectiveTransformerLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {
      }
	...
	virtual inline const char* type() const { return "ProjectiveTransformer"; }
